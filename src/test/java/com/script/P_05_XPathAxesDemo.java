...
public class P_05_XPathAxesDemo {
...
//		String text1=driver.findElement(By.xpath("//a[contains(text(),'Zomato')]/parent::td")).getText();// there is no text for parent, so it is same value display
